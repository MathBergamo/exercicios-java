...
public class Smartphone {
    ...
    //Transitividade: para x,y,z diferentes de null, se x.equals(y) == true, e x.equals(z) == true, logo, y.equals == true
    //Consistente: x.equals(x) sempre retorna true se x for diferente de nulll
